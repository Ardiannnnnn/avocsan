...
export const AVOCADO_CLASSES: Record<string, AvocadoClassInfo> = {
  'Mentah': {
    ...
    color: '#22c55e',
    shelfLife: '5-7 hari',
    recommendation: '✨ Simpan di suhu ruang hingga empuk saat ditekan. Proses pematangan memakan waktu 3-5 hari. Jangan simpan di kulkas saat masih mentah!',
    description: '🌱 Alpukat masih keras dan belum matang. Kulit berwarna hijau terang, daging buah keras, dan belum cocok untuk dikonsumsi. Tunggu beberapa hari untuk matang sempurna.'
  },
  'Mengkal': {
    label: 'Mengkal',
    stage: 'Mengkal',
  ...
  'Matang': {
    ...
    description: '✨ Alpukat matang sempurna! Empuk saat ditekan lembut, kulit berwarna hijau gelap hingga ungu kehitaman. Daging buah lembut, creamy, dan kaya rasa. Ini saat terbaik!'
  },
  'Sangat Matang': {
    label: 'Sangat Matang',
    stage: 'Sangat Matang',
    ...
    color: '#f97316',
    shelfLife: '< 1 hari',
    recommendation: '⚡ Segera konsumsi atau simpan di kulkas! Cocok untuk smoothie, saus, atau dipanggang. Jangan biarkan lebih dari 1 hari di suhu ruang.',
